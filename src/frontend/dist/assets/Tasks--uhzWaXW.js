import { c as createLucideIcon, e as commonjsGlobal, g as getDefaultExportFromCjs, r as reactExports, f as clsx, R as React, b as useLocalStorage, j as jsxRuntimeExports, m as motion, G as GoldButton, A as AnimatePresence, T as Target } from "./index-CBgNZDlk.js";
...
import { T as Trash2 } from "./trash-2-BqGINgwl.js";
...
function ChartTooltip({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glassmorphism rounded-lg px-3 py-2 text-xs font-display", children: [
...
function AddTaskForm({ onAdd, onCancel }) {
  ...
  const submit = () => {
    ...
    onAdd({
      ...
      priority,
      category,
      dueDate: dueDate ? new Date(dueDate).getTime() : void 0,
      createdAt: Date.now()
    });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(GlassCard, { glow: true, padding: "md", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-sm text-foreground", children: "New Task" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              ...
              onKeyDown: (e3) => e3.key === "Enter" && submit(),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "select",
                {
                  id: "task-priority",
                  value: priority,
                  onChange: (e3) => setPriority(e3.target.value),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "select",
                {
                  ...
                  children: CATEGORIES.slice(1).map((c2) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: c2, children: c2 }, c2))
                }
              )
            ] })
          ] }),
...
function AddGoalForm({ onAdd, onCancel }) {
  ...
  const submit = () => {
    ...
    onAdd({
      ...
      targetDate: targetDate ? new Date(targetDate).getTime() : Date.now() + 90 * DAY,
      progress: 0,
      category,
      createdAt: Date.now(),
      milestones: []
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(GlassCard, { glow: true, padding: "md", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-sm text-foreground", children: "New Goal" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  ...
                  type: "date",
                  value: targetDate,
                  onChange: (e3) => setTargetDate(e3.target.value),
                  className: "w-full bg-muted/50 border border-border rounded-lg px-2 py-1.5 text-xs text-foreground focus:outline-none focus:ring-2 focus:ring-ring font-body",
...
function GoalCard({ goal, index, onUpdateProgress, onDelete }) {
  const [editing, setEditing] = reactExports.useState(false);
  const [slider, setSlider] = reactExports.useState(goal.progress);
  const daysLeft = Math.ceil((goal.targetDate - Date.now()) / DAY);
  const save = () => {
    onUpdateProgress(goal.id, slider);
    setEditing(false);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(GlassCard, { hover: true, "data-ocid": `goals.item.${index + 1}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 mb-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-xl bg-primary/20 border border-primary/30 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Target, { size: 16, className: "text-primary" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-sm text-foreground truncate", children: goal.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body line-clamp-1", children: goal.description })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 shrink-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(GoldBadge, { variant: "muted", children: goal.category }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ProgressBar, { value: goal.progress, size: "md", className: "flex-1" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 text-xs text-primary font-display font-bold shrink-0", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground font-body", children: daysLeft > 0 ? `${daysLeft}d left` : "Overdue" }),
      ...
      ) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-1 ml-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "range",
            ...
            step: "5",
            value: slider,
            onChange: (e3) => setSlider(Number(e3.target.value)),
            className: "flex-1 accent-primary",
            "data-ocid": `goals.progress_slider.${index + 1}`
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-primary font-display font-bold w-8 text-right", children: [
          slider,
          "%"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function Tasks() {
  ...
  const [showAddGoal, setShowAddGoal] = reactExports.useState(false);
  ...
  const filteredTasks = reactExports.useMemo(() => {
    return tasks.filter((t2) => {
      const catOk = categoryFilter === "All" || t2.category === categoryFilter;
      const priOk = priorityFilter === "all" || t2.priority === priorityFilter;
      return catOk && priOk;
    });
  }, [tasks, categoryFilter, priorityFilter]);
  const pending = filteredTasks.filter((t2) => !t2.completed);
  const done = filteredTasks.filter((t2) => t2.completed);
  const completionPct = tasks.length === 0 ? 0 : Math.round(
    tasks.filter((t2) => t2.completed).length / tasks.length * 100
  );
  const usedCategories = reactExports.useMemo(
    () => ["All", ...Array.from(new Set(tasks.map((t2) => t2.category)))],
    [tasks]
  );
  const toggleTask = (id) => setTasks(
    (prev) => prev.map((t2) => t2.id === id ? { ...t2, completed: !t2.completed } : t2)
  );
  const deleteTask = (id) => setTasks((prev) => prev.filter((t2) => t2.id !== id));
  const addTask = (task) => {
  ...
  const updateGoalProgress = (id, progress) => setGoals((prev) => prev.map((g2) => g2.id === id ? { ...g2, progress } : g2));
  const deleteGoal = (id) => setGoals((prev) => prev.filter((g2) => g2.id !== id));
    ...
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between pt-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-2xl gradient-gold-text", children: "Tasks & Goals" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body mt-0.5", children: "Track progress. Build momentum." })
          ] }),
          tab === "tasks" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            GoldButton,
            {
              size: "sm",
          ...
          tab === "goals" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            GoldButton,
            {
              size: "sm",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: ["tasks", "goals"].map((t2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                role: "tab",
                ...
                onClick: () => setTab(t2),
                "data-ocid": `tasks.${t2}.tab`,
                className: `flex-1 py-2 px-3 rounded-lg text-sm font-display font-medium transition-smooth ${tab === t2 ? "bg-primary text-primary-foreground gold-glow" : "text-muted-foreground hover:text-foreground"}`,
                children: t2 === "tasks" ? "Daily Tasks" : "Long-Term Goals"
              },
              t2
            ))
          }
        ),
        tab === "tasks" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(GlassCard, { padding: "sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-display font-semibold text-foreground", children: "Today's Progress" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-display font-bold text-primary", children: [
                completionPct,
                "%"
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ProgressBar, { value: completionPct, size: "lg", animated: true }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between mt-2 text-xs text-muted-foreground font-body", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1.5 overflow-x-auto scrollbar-none pb-1", children: usedCategories.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                onClick: () => setCategoryFilter(cat),
                "data-ocid": `tasks.category_filter.${cat.toLowerCase()}`,
                className: `shrink-0 px-3 py-1 rounded-full text-xs font-display font-medium transition-smooth border ${categoryFilter === cat ? "border-primary bg-primary/20 text-primary" : "border-border bg-muted/30 text-muted-foreground hover:text-foreground"}`,
                children: cat
              },
              cat
            )) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1.5", children: PRIORITIES.map((p2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                onClick: () => setPriorityFilter(p2),
                "data-ocid": `tasks.priority_filter.${p2}`,
                className: `flex-1 py-1 rounded-lg text-xs font-display font-medium transition-smooth border capitalize ${priorityFilter === p2 ? "border-primary bg-primary/20 text-primary" : "border-border bg-muted/30 text-muted-foreground hover:text-foreground"}`,
                children: p2 === "all" ? "All" : p2 === "high" ? "🔴 High" : p2 === "medium" ? "🟡 Med" : "⚪ Low"
              },
              p2
            )) })
          ] }),
          ...
          pending.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-display font-semibold text-muted-foreground uppercase tracking-wider", children: [
              "Pending · ",
              pending.length
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: pending.map((task, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  GlassCard,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-foreground truncate", children: task.title }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-0.5", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: task.category }),
                          task.dueDate && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground", children: [
                            "·",
                            " ",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 shrink-0", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(GoldBadge, { variant: PRIORITY_BADGE[task.priority], children: PRIORITY_LABEL[task.priority] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "button",
                          {
                            type: "button",
          ...
          done.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-display font-semibold text-muted-foreground uppercase tracking-wider", children: [
              "Completed · ",
              done.length
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: done.map((task, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
                initial: { opacity: 0 },
                animate: { opacity: 1 },
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          ...
                          children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { size: 20, className: "text-primary" })
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground line-through truncate", children: task.title }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: task.category })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(GoldBadge, { variant: PRIORITY_BADGE[task.priority], children: PRIORITY_LABEL[task.priority] })
                    ]
          ...
          filteredTasks.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            GlassCard,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-full bg-primary/15 border border-primary/25 flex items-center justify-center mx-auto mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { size: 24, className: "text-primary" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground mb-1", children: tasks.length === 0 ? "No tasks yet" : "No tasks match filters" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-body mb-4", children: tasks.length === 0 ? "Add your first task to start building momentum" : "Try a different category or priority filter" }),
        ...
        tab === "goals" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: showAddGoal && /* @__PURE__ */ jsxRuntimeExports.jsx(
            AddGoalForm,
            {
              onAdd: addGoal,
          ...
          goals.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: goals.map((goal, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              initial: { opacity: 0, y: 8 },
              animate: { opacity: 1, y: 0 },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(GlassCard, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-lg bg-primary/20 border border-primary/30 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { size: 14, className: "text-primary" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-sm text-foreground", children: "Completion Trend" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body", children: "Past 6 months · tasks completed" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-40", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              BarChart,
              {
                data: MONTHLY_DATA,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 mt-3 overflow-x-auto scrollbar-none", children: MONTHLY_DATA.map((d2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 text-center min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-display font-bold text-primary", children: d2.completed }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: d2.month })
            ] }, MONTHS[i])) })
          ] }),
          goals.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            GlassCard,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-full bg-primary/15 border border-primary/25 flex items-center justify-center mx-auto mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Target, { size: 24, className: "text-primary" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground mb-1", children: "No goals set" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-body mb-4", children: "Set your first ambitious goal and track progress" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  GoldButton,
                  {
                    size: "sm",
